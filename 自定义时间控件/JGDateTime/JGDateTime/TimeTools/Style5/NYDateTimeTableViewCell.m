...
- (NSInteger)pickerView:(UIPickerView *)pickerView numberOfRowsInComponent:(NSInteger)component
{
        switch (component) {
            ...
            case 2:{
                if ([self.datePickerView selectedRowInComponent:1]== 3 ||[self.datePickerView selectedRowInComponent:1]== 5||[self.datePickerView selectedRowInComponent:1]== 8||[self.datePickerView selectedRowInComponent:1]== 10) {
                     return 30;
                }else {
                    if ([self.datePickerView selectedRowInComponent:1]== 1) {
                
                        if (!(([self.datePickerView selectedRowInComponent:0]+1900)%4)) {
                             return 29;
                        }else {
                            return 28;
                        }
                    ...
                    if ([self.datePickerView selectedRowInComponent:1]== 0 ||[self.datePickerView selectedRowInComponent:1]== 2||[self.datePickerView selectedRowInComponent:1]== 4||[self.datePickerView selectedRowInComponent:1]== 6||[self.datePickerView selectedRowInComponent:1]== 6||[self.datePickerView selectedRowInComponent:1]== 7||[self.datePickerView selectedRowInComponent:1]== 9||[self.datePickerView selectedRowInComponent:1]== 11) {
                        return 31;
                    }
                }
            }
...
- (void)pickerView:(UIPickerView *)pickerView didSelectRow:(NSInteger)row inComponent:(NSInteger)component
{
    ...
    NSInteger sss = [self.datePickerView selectedRowInComponent:2];
        switch (component) {
            case 0:
            {
                NSInteger year = 1900 + row ;
                [self.selectedComponents setYear:year];
                [self.selectedComponents setDay:sss +1];
